...
public class ModBlock {
    ...
    public static final RegistryObject<Block> DEEPSLATE_ALUMINUM = registerBlock("deepslate_aluminum",
            () -> new Block(BlockBehaviour.Properties.of(Material.METAL)
                    .strength(6f).requiresCorrectToolForDrops()));

    public static final RegistryObject<Block> DEEPSLATE_TIN = registerBlock("deepslate_tin",
            () -> new Block(BlockBehaviour.Properties.of(Material.METAL)
                    .strength(6f).requiresCorrectToolForDrops()));

    public static final RegistryObject<Block> DEEPSLATE_TITANIUM = registerBlock("deepslate_titanium",
            () -> new Block(BlockBehaviour.Properties.of(Material.METAL)
                    .strength(6f).requiresCorrectToolForDrops()));
